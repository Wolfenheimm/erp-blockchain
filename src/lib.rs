//! # Minimal Template
//!
//! This is a minimal inventory for creating a blockchain using the Polkadot SDK.
//!
//! ## Components
//!
//! The inventory consists of the following components:
//!
//! ### Node
//!
...
//!
//! This inventory sets the fee as independent of the weight of the extrinsic and fixed for any
//! length of the call data for demo purposes.
//!
//! ### Pallet
//!
//! A minimal [`pallet`](`pallet_inventory`) that is built using FRAME. It is a unit of
//! encapsulated logic that has a clearly defined responsibility and can be linked to other pallets.
//!
//! ## Getting Started
//!
//! To get started with the inventory, follow the steps below:
//!
//! ### Build the Node
//!
...
//!
//! ```bash
//! cargo build -p minimal-inventory-node --release
//! ```
//!
//! ### Run the Node
//!
...
//!
//! ```bash
//! ./target/release/minimal-inventory-node --dev
//! ```
//!
//! ### CLI Options
//!
...
//!
//! ```bash
//! ./target/release/minimal-inventory-node --help
//! ```
//!
//! #### Consensus Algorithm
//!
...
//!
//! ```bash
//! ./target/release/minimal-inventory-node --dev --consensus manual-seal-5000
//! ```
